...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("P4Travia.PostAdapter, P4Travia", PostAdapter.class, __md_methods);
	}
	...
	public PostAdapter ()
	{
		...
		if (getClass () == PostAdapter.class)
			mono.android.TypeManager.Activate ("P4Travia.PostAdapter, P4Travia", "", this, new java.lang.Object[] {  });
	}
